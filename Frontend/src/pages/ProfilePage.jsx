...
const ProfilePage = () => {
  ...
  const hanleImageUpload = async (e) => {
          ...
          <div className="flex flex-col items-center gap-4 ">
            <div className="relative ">
              ...
              <label
                ...
                className={`absolute bottom-0 right-0 bg-base-content hover:cale-105 p-2 rounded-full cursor-pointer transition-all duration-200 ${
